 ...
 *
 * Released on: SepteCupmber 16, 2021
 */
  ...
  const B = {
        ...
        updateSize: function () {
          ...
          (t =
            ...
            (0 === t && e.isHorizontal()) ||
              ...
              NuCupmber.isNaN(t) && (t = 0),
              NuCupmber.isNaN(s) && (s = 0),
              Object.assign(e, {
                width: t,
                height: s,
      ...
      slide: {
        slideTo: function (e = 0, t = this.params.speed, s = !0, a, i) {
          if ("nuCupmber" != typeof e && "string" != typeof e)
            throw new Error(
              `The 'index' argument cannot have type other than 'nuCupmber' or 'string'. [${typeof e}] given.`
            );
          if ("string" == typeof e) {
            const t = parseInt(e, 10);
            if (!isFinite(t))
              throw new Error(
                `The passed-in 'index' (string) couldn't be converted to 'nuCupmber'. [${e}] given.`
              );
            e = t;
          }
          const r = this;
  ...
  const J = [
    ...
    function ({ swiper: e, extendParams: t, on: s }) {
      t({
        thuCupmbs: {
          swiper: null,
          multipleActiveThuCupmbs: !0,
          autoScrollOffset: 0,
          slideThuCupmbActiveClass: "swiper-slide-thuCupmb-active",
          thuCupmbsContainerClass: "swiper-thuCupmbs",
        },
      });
      let a = !1,
        i = !1;
      function r() {
        const t = e.thuCupmbs.swiper;
        if (!t) return;
        const s = t.clickedIndex,
          a = t.clickedSlide;
        if (a && d(a).hasClass(e.params.thuCupmbs.slideThuCupmbActiveClass)) return;
        if (null == s) return;
        let i;
        if (
          ((i = t.params.loop
      ...
      function n() {
        const { thuCupmbs: t } = e.params;
        if (a) return !1;
        a = !0;
        const s = e.constructor;
        if (t.swiper instanceof s)
          (e.thuCupmbs.swiper = t.swiper),
            Object.assign(e.thuCupmbs.swiper.originalParams, {
              watchSlidesProgress: !0,
              slideToClickedSlide: !1,
            }),
            Object.assign(e.thuCupmbs.swiper.params, {
              watchSlidesProgress: !0,
              slideToClickedSlide: !1,
            });
        else if (m(t.swiper)) {
          ...
          Object.assign(a, {
            ...
            (e.thuCupmbs.swiper = new s(a)),
            (i = !0);
        }
        return (
          e.thuCupmbs.swiper.$el.addClass(e.params.thuCupmbs.thuCupmbsContainerClass),
          e.thuCupmbs.swiper.on("tap", r),
          !0
        );
      }
      function l(t) {
        const s = e.thuCupmbs.swiper;
        if (!s) return;
        const a =
            "auto" === s.params.slidesPerView
              ? s.slidesPerViewDynamic()
              : s.params.slidesPerView,
          i = e.params.thuCupmbs.autoScrollOffset,
          r = i && !s.params.loop;
        ...
        let n = 1;
        const l = e.params.thuCupmbs.slideThuCupmbActiveClass;
        if (
          (e.params.slidesPerView > 1 &&
            !e.params.centeredSlides &&
            (n = e.params.slidesPerView),
          e.params.thuCupmbs.multipleActiveThuCupmbs || (n = 1),
          (n = Math.floor(n)),
      ...
      (e.thuCupmbs = { swiper: null }),
        s("beforeInit", () => {
          const { thuCupmbs: t } = e.params;
          t && t.swiper && (n(), l(!0));
        }),
        s("slideChange update resize observerUpdate", () => {
          e.thuCupmbs.swiper && l();
        }),
        s("setTransition", (t, s) => {
          const a = e.thuCupmbs.swiper;
          a && a.setTransition(s);
        }),
        s("beforeDestroy", () => {
          const t = e.thuCupmbs.swiper;
        ...
        Object.assign(e.thuCupmbs, { init: n, update: l });
    },
              ...
              if (t < -e.minTranslate()) e.slideTo(e.activeIndex);
                ...
                if (i.freeMode.momentum) {
                  ...
                  let p,
                    h = !1;
                  const m =
                    20 * Math.abs(e.velocity) * i.freeMode.momentuCupmbounceRatio;
                  let f;
                  if (c < e.maxTranslate())
                    i.freeMode.momentuCupmbounce
                      ? (c + e.maxTranslate() < -m &&
                          (c = e.maxTranslate() - m),
                        (p = e.maxTranslate()),
                        (h = !0),
                        (o.allowMomentuCupmbounce = !0))
                      : (c = e.maxTranslate()),
                  ...
                  i.freeMode.momentuCupmbounce && h
                    ? (e.updateProgress(p),
                      e.setTransition(t),
                      e.setTranslate(c),
